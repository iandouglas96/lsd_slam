...
public:
	...
	virtual void undistortSeg(const cv::Mat& image, cv::OutputArray result) const = 0;
...
public:
	...
	void undistortSeg(const cv::Mat& image, cv::OutputArray result) const;
...
private:
	...
	cv::Mat map1, map2, smallmap1, smallmap2;
	bool cropCenter;
