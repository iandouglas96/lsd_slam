...
public:
	...
	SE3DepthTracker(int w, int h, Eigen::Matrix3f K);
	SE3DepthTracker(const SE3DepthTracker&) = delete;
	SE3DepthTracker& operator=(const SE3DepthTracker&) = delete;
	~SE3DepthTracker();
