...
public:
	 ...
	 */
	inline NotifyBuffer<TimestampedMultiMat>* getImageBuffer() {return imageBuffer;};
	inline NotifyBuffer<TimestampedSegmentation>* getSegBuffer() {return segBuffer;};
...
protected:
	...
	NotifyBuffer<TimestampedSegmentation>* segBuffer;
